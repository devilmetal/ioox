...
<!--
        ...
        @date:     16.07.2013
        @version:  1.0
        @desc:      XSLT le page page courses admin, cette page permet de chercher dans les cours pour la création/mofification/clonage/suppression d'un cours.
                    -->
                ...
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        ...
                        <!-- Affichage
                            ...
                            cas 2) child = Back => affichage de la recherche.
                        -->
                        <div class="row-fluid">
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    ...
                                    <button class="btn btn-gebo" type="submit">Search for a
                                        course</button>
                                    <a class="btn btn-gebo" href="{$xslt.base-url}admin/courses/new"
                                        >Create a course</a>
                                </div>
                            </div>
                        </fieldset>
        ...
        <tr>
            <form class="form-horizontal" method="post" action="#">
                ...
                <td class="center">
                    ...
                    <br/>
                    <a class="btn btn-gebo btn-mini"
                        href="{$xslt.base-url}admin/courses/{$courseid}">Modifiy</a>
                    <br/>
                    <a class="btn btn-gebo btn-mini"
                        href="{$xslt.base-url}admin/courses/new?id={$courseid}">Clone</a>
                </td>
            </form>
        </tr>
