...
<!--  
        ...
        @date:     16.07.2013
        @version:  1.0
        @desc:     XSLT pour la page de suppresion d'un utilisateur. (formulaire de recherche et suppression).
                    -->
                ...
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        ...
                        <!-- Affichage
                            ...
                            cas 2) child = Back => retour du formulaire + boutons pour suppression.
                        -->
                        <div class="row-fluid">
