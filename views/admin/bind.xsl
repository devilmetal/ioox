                    ...
                    <div class="control-group formSep">
                        ...
                        <div class="controls text_line">
                            <xsl:apply-templates select="./Teachers">
                                <xsl:with-param name="CourseId"><xsl:value-of select="CourseId"/></xsl:with-param>
                            </xsl:apply-templates>
                        </div>
                        <div class="controls">
                            <xsl:variable name="courseid"><xsl:value-of select="CourseId"/></xsl:variable>
                            <a class="btn btn-gebo" href="{$xslt.base-url}admin/bind/{$courseid}">Add teachers</a>
                        </div>
                    </div>
                </fieldset>
        </div>
    ...
    <xsl:template match="Teachers">
        ...
        <xsl:for-each select="Teacher">
            ...
            <form method="POST" action="#">
                ...
                <input class="btn btn-gebo" type="submit" value="Remove this teacher"/>
            </form>
        </xsl:for-each>
    </xsl:template>
