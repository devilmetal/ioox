...
<!-- Home View
        ...
        @date:     16.07.2013
        @version:  1.0
        @desc:     XSLT la page bindcourse qui permet de lier les cours à un prof.
                    -->
                        ...
                        <fieldset>
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    ...
                                    <button class="btn btn-gebo" type="submit">Search for an
                                        user</button>
                                </div>
                            </div>
                        </fieldset>
        ...
        <tr>
            ...
            <td class="center">
                ...
                <form method="post" action="#">
                    ...
                    <button class="btn btn-gebo btn-mini" type="submit">Bind as teacher</button>
                </form>
                <form method="post" action="#">
                    <input type="hidden" name="role" value="Tutor"/>
                    <input name="personid" value="{$personid}" type="hidden"/>
                    <button class="btn btn-gebo btn-mini" type="submit">Bind as tutor</button>
                </form>
            </td>
