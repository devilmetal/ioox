...
<!--
     ...
     Quizz generator
  -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" xmlns:site="http://oppidoc.com/oppidum/site" version="1.0">
  ...
  <xsl:variable name="path.quizz.css"><xsl:value-of select="$xslt-ressource-url"/>/css/quizz.css</xsl:variable>
  <xsl:variable name="path.quizz.js"><xsl:value-of select="$xslt-ressource-url"/>/js/quizz.js</xsl:variable>
