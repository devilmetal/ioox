...
<!-- 
        ...
        @date:     16.07.2013
        @version:  1.0
        @desc:     XSLT pour la modification des resultats des étudiants par un prof. Affichage des personnes qui suivent le cours.
                    -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:template match="Students">
      <!-- Table qui contient les étudiants et le bouton vers leurs notes. -->
      <div class="span8">
                  ...
                  <tr>
                     ...
                     <td>
                        <a class="btn btn-gebo"
                           href="{$xslt.base-url}{./ancestor::Students/Trail}/{PersonId}">Grades</a>
                     </td>
                  </tr>
               </xsl:for-each>
            </tbody>
