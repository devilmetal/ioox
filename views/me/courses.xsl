...
<!-- 
        ...
        @date:      16.07.2013
        @version:   1.0
        @desc:      Generate the page that offer the possibility to select the course to open
                    only subscribed course!
                    -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="Null">
        <p>You have either tho register in courses other to login in order to access your
            courses.</p>
    </xsl:template>

    <!-- Print the period information -->
    ...
    <!--   Print the course square like a apps  
            If i'm teacher or tutor add link to manager-->
            ...
            <xsl:choose>
                <xsl:when test="count(.[Role!='Student'])=0">
                    <div class="ourbox obc1 bb">
                        ...
                        <br/>
                        <a href="{$xslt.base-url}me/courses/{$id}" class="btn btn-inverse btn-mini"
                                ><i class="splashy-arrow_medium_upper_right"/> go to</a>
                ...
                <xsl:otherwise>
                    <div class="ourbox obc4 bb">
                        ...
                        <a href="{$xslt.base-url}me/courses/{$id}" class="btn btn-inverse btn-mini"
                                ><i class="splashy-arrow_medium_upper_right"/> go to</a>
                        <a href="{$xslt.base-url}me/courses/{$id}/teaching"
                            class="btn btn-warning btn-mini"><i
                                class="splashy-arrow_medium_upper_right"/> manage</a>
