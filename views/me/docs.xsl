...
<!--
        ...
        @date:     16.07.2013
        @version:  1.0
        @desc:     XSLT pour l'affichage de la page vers les pdf des cours suivits avec des Mynotes.
                    -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        ...
        <site:view>
            ...
            <site:content>
                <xsl:apply-templates
                    select="/Root//child::node()[name()='Error' or name()='Period']"/>
            </site:content>
            <site:javascript>
    ...
    <xsl:template match="Course">
        <tr>
            ...
            <td>
                <a href="{$xslt.base-url}me/courses/{$id}">Link to the course</a>
            </td>
        </tr>
    </xsl:template>
    ...
    <xsl:template match="Course" mode="new">
        <div class="span4">
            ...
            <div class="ourbox obc1">
                ...
                <br/>
                <a href="{$xslt.base-url}me/docs/{$id}" class="btn btn-inverse btn-mini"><i
                        class="splashy-arrow_medium_upper_right"/>Acces to the PDF</a>
            </div>
        </div>
